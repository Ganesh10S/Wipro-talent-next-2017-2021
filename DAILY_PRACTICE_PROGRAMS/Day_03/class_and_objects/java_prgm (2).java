...
3 Design a class that can be used by a health care professional to keep track of a patient’s vital
...
Topics Covered: Classes and Objects, Constructor, static

*******************************************************************************/
class patient
{
    String name;
    double height,weight,k;
    double bmi()
    {
        k=(weight/(height*height))*703;
        return k;
    }
}
public class Main
